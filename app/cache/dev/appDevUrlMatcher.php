    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if ($pathinfo === '/user/login') {
                return array (  '_controller' => 'AppBundle\\Controller\\UserController::loginAction',  '_route' => 'login_form',);
            }

            // cerrar
            if ($pathinfo === '/user/cerrar') {
                return array (  '_controller' => 'AppBundle\\Controller\\UserController::cerrarAction',  '_route' => 'cerrar',);
            }
        ...
        if (0 === strpos($pathinfo, '/video')) {
            ...
            if (rtrim($pathinfo, '/') === '/video') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\VideoController::indexAction',  '_route' => 'video_index',);
            }
            not_video_index:
            ...
            // video_download
            if (0 === strpos($pathinfo, '/video/download') && preg_match('#^/video/download/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_video_download;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'video_download')), array (  '_controller' => 'AppBundle\\Controller\\VideoController::downloadAction',));
            }
            not_video_download:
            ...
            if (preg_match('#^/video/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'video_edit')), array (  '_controller' => 'AppBundle\\Controller\\VideoController::editAction',));
            }
            not_video_edit:
            ...
            if (preg_match('#^/video/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'video_delete')), array (  '_controller' => 'AppBundle\\Controller\\VideoController::deleteAction',));
            }
            not_video_delete:
